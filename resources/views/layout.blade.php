          ...
          <div class="col-sm-12">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
              ...
              <a href="index.html" class="navbar-brand">
                <img src="{{ asset("images/logo.png") }}" class="img-fluid logo" alt="" />
              </a>
                    ...
                    <ul class="d-flex align-items-center justify-content-end list-inline m-0">
                            ...
                            <div class="iq-card-body">
                              <a href="#" class="iq-sub-card">
                                <div class="media align-items-center">
                                  <img src="{{ asset("images/notify/thumb-1.jpg") }}" alt="" class="img-fluid mr-3" />
                              ...
                              <a href="#" class="iq-sub-card">
                                <div class="media align-items-center">
                                  <img src="{{ asset("images/notify/thumb-2.jpg") }}" alt="" class="img-fluid mr-3" />
                                  <div class="media-body">
                                    <h6 class="mb-0">
                              ...
                              <a href="#" class="iq-sub-card">
                                <div class="media align-items-center">
                                  <img src="{{ asset("images/notify/thumb-3.jpg") }}" alt="" class="img-fluid mr-3" />
                                  <div class="media-body">
                      ...
                      <li>
                        <a href="#" class="iq-user-dropdown search-toggle d-flex align-items-center">
                          <img src="{{ asset("images/user/user.png") }}" class="img-fluid user-m rounded-circle" alt="" />
                        </a>
        ...
        <div class="container-fluid position-relative h-100">
          <div class="slider-inner h-100">
              ...
              <div class="col-xl-6 col-lg-12 col-md-12">
                <a href="javascript:void(0)">
                  <div class="channel-logo" data-animation-in="fadeInLeft" data-delay-in="0.5">
                    <img src="{{ asset("images/logo.png") }}" class="c-logo" alt="" />
                  </div>
                </a>
            ...
            <div class="col-xl-5 col-lg-12 col-md-12 trailor-video">
              <a href="{{ asset("video/trailer.mp4") }}" class="video-open playbtn">
                <img src="{{ asset("images/play.png") }}" class="play" alt="" />
              ...
              <ul class="favorites-slider list-inline row p-0 mb-0">
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/favorite/f1.jpg") }}" class="img-fluid" alt="" />
                    </div>
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/favorite/f2.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                        <a href="#"> War </a>
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/favorite/f3.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/favorite/f4.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                        <a href="#"> Chhichore </a>
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/favorite/f5.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
            ...
            <div class="favorite-contens">
              <ul class="favorites-slider list-inline row p-0 mb-0">
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/popular/u1.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                        <a href="#"> Mulan </a>
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/popular/u3.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/popular/u4.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/popular/u5.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
          ...
          <div class="col-sm-12 overflow-hidden">
            <div class="topten-contents">
              ...
              <ul id="top-ten-slider" class="list-inline p-0 m-0 d-flex align-items-center">
                <li class="slick-bg">
                  <a href="#">
                    <img src="{{ asset("images/top-10/01.jpg") }}" class="img-fluid w-100" alt="" />
                    <h6 class="iq-title"><a href="#">Harry Potter</a></h6>
                  </a>
                </li>
                <li class="slick-bg">
                  <a href="#">
                    <img src="{{ asset("images/top-10/02.jpg") }}" class="img-fluid w-100" alt="" />
                    <h6 class="iq-title">
                ...
                <li class="slick-bg">
                  <a href="#">
                    <img src="{{ asset("images/top-10/03.jpg") }}" class="img-fluid w-100" alt="" />
                    <h6 class="iq-title"><a href="#">Scam 1992</a></h6>
                  </a>
                </li>
                <li class="slick-bg">
                  <a href="#">
                    <img src="{{ asset("images/top-10/04.jpg") }}" class="img-fluid w-100" alt="" />
                    <h6 class="iq-title"><a href="#">Stranger Things</a></h6>
                  </a>
                </li>
                <li class="slick-bg">
                  <a href="#">
                    <img src="{{ asset("images/top-10/05.jpg") }}" class="img-fluid w-100" alt="" />
                    <h6 class="iq-title"><a href="#">BoJack Horsemen</a></h6>
                  </a>
                </li>
                <li class="slick-bg">
                  <a href="#">
                    <img src="{{ asset("images/top-10/06.jpg") }}" class="img-fluid w-100" alt="" />
            ...
            <div class="favorite-contens">
              <ul class="favorites-slider list-inline row p-0 mb-0">
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/suggested/01.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                        <a href="#"> Basketball </a>
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/suggested/02.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                        <a href="#"> VolleyBall </a>
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/suggested/03.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                        <a href="#"> Basketball </a>
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/suggested/04.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                        <a href="#"> Cricket </a>
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/suggested/05.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                        <a href="#"> Golf </a>
        ...
        <div class="row align-items-center justify-content-center h-100 parallaxt-details">
          ...
          <div class="col-lg-8">
            <div class="parallax-img">
              <a href="#"><img src="{{ asset("images/parallax/avatar.jpg") }}" alt="" class="img-fluid w-100" /></a>
            </div>
          </div>
        </div>
      </div>
                        ...
                        <div id="trending-data1" class="overview-tab tab-pane fade active show">
                          <div class="trending-info align-items-center w-100 animated fadeInUp">
                            ...
                            <div class="d-flex align-items-center series mb-4">
                              <a href="javascript:void(0);">
                                <img src="{{ asset("images/trending/trending-label.png") }}" class="img-fluid" alt="">
                              </a>
                              ...
                              <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 m-0">
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/ce1.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/ce2.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/ce3.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/ce4.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/ce5.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                            ...
                            <div class="episodes-contens mt-4">
                              <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 m-0">
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/bbt3.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/fe2.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/m4.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/pb3.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/n5.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                            ...
                            <div class="episodes-contens mt-4">
                              <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 m-0">
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/bbt1.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/bbt2.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/bbt4.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/bbt5.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                            ...
                            <div class="episodes-contens mt-4">
                              <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 m-0">
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/pb1.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/pb2.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/pb4.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/pb5.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                            ...
                            <div class="episodes-contens mt-4">
                              <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 m-0">
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/n1.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/n2.png") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/n3.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/n4.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                            ...
                            <div class="episodes-contens mt-4">
                              <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 m-0">
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/fe1.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/fe3.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/fe4.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/fe5.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                            ...
                            <div class="episodes-contens mt-4">
                              <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 m-0">
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/m1.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/m2.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/m3.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
                                ...
                                <div class="e-item">
                                  <div class="block-image position-relative">
                                    <a href="#">
                                      <img src="{{ asset("images/episodes/m5.jpg") }}" class="img-fluid" alt="">
                                    </a>
                                    <div class="episode-play-info">
                                      <div class="episode-play">
                                        <a href="#" tabindex="0">
            ...
            <div class="favorite-contens">
              <ul class="favorites-slider list-inline row p-0 mb-0">
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/tvthrillers/03.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                        <a href="#">Kingsman</a>
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/tvthrillers/04.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
                ...
                <li class="slide-item">
                  <div class="block-images position-relative">
                    <div class="img-box">
                      <img src="{{ asset("images/tvthrillers/05.jpg") }}" class="img-fluid" alt="" />
                    </div>
                    <div class="block-description">
                      <h6 class="iq-title">
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
            <div class="widget text-left">
              <div class="textwidget">
                ...
                <div class="d-flex align-items-center">
                  <a href="#"><img src="{{ asset("images/footer/01.jpg") }}" alt=""></a>
                  <br>
                  <a href="#" class="ml-3"><img src="{{ asset("images/footer/02.jpg") }}" alt=""></a>
                </div>
              </div>
            </div>
          </div>
